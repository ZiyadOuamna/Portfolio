...
export default function Hero() {
  ...
  return (
    <section
      id="home"
      className="min-h-screen flex items-center justify-center relative overflow-hidden pt-12 bg-white dark:bg-slate-950"
    >
      {/* Animated Background */}
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 w-full">
        <div className="grid md:grid-cols-[400px_1fr] gap-10 items-center">
          ...
          <motion.div
            ...
            className="hidden md:block relative h-full min-h-130"
          >
            <div
              className="absolute -inset-6 bg-linear-to-r from-indigo-500/25 via-purple-500/20 to-pink-500/25 blur-3xl opacity-80 -z-10"
              aria-hidden
            />
          ...
          <div className="text-center md:text-left pb-8 relative">
            ...
            <motion.h1
              ...
              className="text-4xl md:text-6xl lg:text-7xl font-bold mb-5 text-slate-900 dark:bg-linear-to-r dark:from-white dark:via-slate-200 dark:to-slate-400 dark:bg-clip-text dark:text-transparent"
            >
              Ziyad Ouamna
            </motion.h1>
            ...
            <motion.div
              ...
              className="bg-linear-to-br from-indigo-500/10 to-pink-500/10 border border-indigo-500/25 rounded-xl p-3.5 mb-8 inline-flex items-center gap-2.5"
            >
              <div className="w-2.5 h-2.5 bg-green-500 rounded-full animate-pulse" />
              <div>
                <p className="text-xs md:text-sm font-semibold text-indigo-100">Available for Projects</p>
                <p className="text-slate-300 text-xs md:text-sm">
                  I&apos;m currently available for freelance work and new opportunities. Let&apos;s create something great together!
                </p>
              </div>
            </motion.div>
            ...
            >
              <button
                ...
                className="px-7 py-3.5 border-2 border-slate-400/70 rounded-full font-semibold text-base md:text-lg text-indigo-200 hover:bg-indigo-500/10 hover:border-indigo-400 transform hover:scale-[1.03] hover:translate-y-[-1.5px] transition-all duration-400"
              >
                View My Work
              </button>
              <button
                onClick={() => scrollToSection("#contact")}
                className="px-7 py-3.5 border-2 border-slate-400/70 rounded-full font-semibold text-base md:text-lg text-slate-200 hover:border-indigo-400 hover:bg-indigo-500/10 transform hover:translate-y-[-1.5px] hover:scale-[1.03] transition-all duration-400"
            >
              Get In Touch
            </button>
              <a
