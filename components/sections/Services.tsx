...
const services = [
  ...
  },
  {
    ...
    features: [
      ...
      { icon: Target, text: "Social Media Services & Management" },
    ],
  },
];
...
export default function Services() {
  ...
  return (
    <section id="services" className="min-h-screen md:min-h-screen relative bg-white dark:bg-slate-950 flex items-start pt-24 pb-6 md:py-0 md:items-center overflow-visible">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        >
          <h2 className="text-lg md:text-2xl lg:text-3xl font-bold mb-1.5 md:mb-2">
            Comprehensive{" "}
            <span className="bg-linear-to-r from-indigo-500 via-purple-500 to-pink-500 bg-clip-text text-transparent">
              Services
            </span>
          </h2>
          <p className="text-slate-400 text-[10px] md:text-sm max-w-xl mx-auto leading-relaxed">
        ...
        >
          {services.map((service, index) => {
            ...
            return (
              ...
              >
                {/* Card */}
                <div className="relative h-full dark:bg-slate-800/50 bg-slate-100 backdrop-blur-sm border dark:border-slate-700 border-slate-200 rounded-xl md:rounded-2xl p-3 md:p-5 dark:hover:border-slate-600 hover:border-slate-300 transition-all duration-300">
                  ...
                  {/* Icon */}
                  <div className={`w-8 md:w-10 h-8 md:h-10 mb-2 md:mb-3 bg-linear-to-br ${service.gradient} rounded-lg md:rounded-xl flex items-center justify-center relative z-10 group-hover:scale-110 transition-transform duration-300`}>
                      ...
                      return (
                        ...
                        >
                          <div className={`w-4 md:w-5 h-4 md:h-5 bg-linear-to-br ${service.gradient} bg-opacity-10 rounded-lg flex items-center justify-center shrink-0`}>
                            <FeatureIcon className="w-2 md:w-2.5 h-2 md:h-2.5" />
                          </div>
                          <span className="text-[9px] md:text-xs">{feature.text}</span>
                        </div>
                      );
                    })}
                  </div>
                  ...
                  {/* Number indicator */}
                  <div className={`absolute top-8 right-8 text-6xl font-bold bg-linear-to-br ${service.gradient} bg-clip-text text-transparent opacity-10 group-hover:opacity-20 transition-opacity duration-300`}>
                    0{index + 1}
                  </div>
                </div>
              </motion.div>
        ...
        >
          <p className="text-slate-400 mb-2 md:mb-2.5 text-[9px] md:text-xs">
          ...
          <button
            ...
            className="px-4 md:px-5 py-1.5 md:py-2 text-xs md:text-sm bg-linear-to-r from-indigo-500 to-pink-500 rounded-full font-semibold hover:shadow-2xl hover:shadow-indigo-500/50 transform hover:scale-105 transition-all duration-300"
          >
            Start a Project
          </button>
        </motion.div>
